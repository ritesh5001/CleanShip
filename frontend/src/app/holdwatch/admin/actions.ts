...
import { hwClients as clients, hwJobs as jobs, users } from "@/lib/db/schema";
import { createJob, newShareToken } from "@/lib/holdwatch/jobs";
...
export async function createJobAction(
  ...
  revalidatePath("/holdwatch/admin");
  redirect(`/holdwatch/admin/jobs/${job.id}`);
}
...
export async function assignSupervisorAction(formData: FormData) {
  ...
  revalidatePath(`/holdwatch/admin/jobs/${jobId}`);
}
...
export async function createClientAction(
  ...
  revalidatePath("/holdwatch/admin/clients");
...
export async function createUserAction(
  ...
  revalidatePath("/holdwatch/admin/users");
