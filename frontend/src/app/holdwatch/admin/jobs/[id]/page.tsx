...
import { StageBoard } from "@/components/holdwatch/stage-board";
import { Card, JobStatusChip, PageTitle } from "@/components/holdwatch/ui";
import { db } from "@/lib/db";
import { users } from "@/lib/db/schema";
import { getJobDetail, getJobEvents, jobProgress } from "@/lib/holdwatch/jobs";
import { env } from "@/lib/env";
import { formatDate, formatDateTime } from "@/lib/format";
import type { JobType } from "@/lib/holdwatch/stages";
import {
...
import { CopyField } from "@/components/holdwatch/copy-field";
...
export default async function AdminJobPage({
  ...
  return (
    <AppShell session={session} wide>
      <Link href="/holdwatch/admin" className="text-[13px] font-medium text-blue-700 hover:underline">
        ← All jobs
      </Link>
