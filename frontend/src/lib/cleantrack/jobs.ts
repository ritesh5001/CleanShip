...
import { db } from "../db";
import {
  ctClients as clients,
  ctCompartments as compartments,
  ctJobs as jobs,
  ctStageEvents as stageEvents,
  users,
  type CtCompartment as Compartment,
  type CtJob as Job,
} from "../db/schema";
import {
  compartmentLabel,
...
/** CT-YYMM-NN, unique per month. Readable over a phone line. */
