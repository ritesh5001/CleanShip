...
import { ClientJobView } from "@/components/client-job-view";
import { canViewJob, getJobDetail } from "@/lib/jobs";
...
export default async function ClientJobPage({
  ...
  return (
    <AppShell session={session}>
      <Link href="/client" className="text-[13px] font-medium text-blue-700 hover:underline">
        ← All your jobs
      </Link>
      <div className="mt-3">
