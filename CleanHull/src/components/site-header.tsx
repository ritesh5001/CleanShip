    ...
    <>
      ...
      <div className="sticky top-0 z-50">
        ...
        <div className="container-page flex h-10 items-center justify-between text-[13px]">
          <p>Hull Performance You Can Trust — cleaning, polishing, survey &amp; UWILD</p>
            ...
            {hullCleaning.services.map((service, i) => (
              ...
              >
                ...
                <span className="mt-2 flex items-start gap-2.5">
                  <CategoryIcon
                    name={hullCleaning.icon}
                    className="mt-0.5 size-[22px] shrink-0 text-blue-600"
                  />
                  <span className="font-display text-[17px] font-bold uppercase leading-tight text-ink-900 transition-colors duration-[140ms] group-hover:text-blue-600">
                    {service.name}
                  </span>
                </span>
                <span className="mt-2.5 block border-l border-line-200 pl-3.5 text-[13px] leading-snug text-slate-600">
                  {service.tagline}
                </span>
              </Link>
            ))}
          ...
          <div className="border-t border-line-100 bg-paper">
            <div className="container-page flex items-center justify-between py-4 text-[14px]">
              <p className="text-slate-600">
                Dive desk manned 24 hours, Mon – Sun.
              </p>
              <Link
                href="/services"
              ...
              item.href === "/services" ? (
                <li key={item.href}>
                  ...
                  {openAccordion === "services" && (
                    <ul className="mb-4 space-y-0.5 border-l border-line-200 pl-4">
                      {hullCleaning.services.map((service) => (
                        <li key={service.slug}>
                          <Link
                            href={`/services/${hullCleaning.slug}/${service.slug}`}
                            className="flex items-center gap-2 py-2 text-[14px] text-slate-600"
                          >
                            <CategoryIcon
                              name={hullCleaning.icon}
