...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "CleanHull Marine Services | Underwater Hull Cleaning & Polishing",
    /* Every child page supplies only its own title; the brand is appended
       here. Kept to "| CleanHull" — a longer "| CleanHull Marine Services"
       suffix would consume 30 of the ~60 characters Google shows before it
       truncates, cutting page titles mid-phrase in results. */
  ...
  openGraph: {
    ...
    title: "CleanHull Marine Services | Underwater Hull Cleaning & Polishing",
    description: siteConfig.shortDescription,
  },
  twitter: {
    card: "summary_large_image",
    title: "CleanHull Marine Services",
    description: siteConfig.shortDescription,
  },
  robots: {
    index: true,
