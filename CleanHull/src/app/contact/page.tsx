...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Contact CleanHull for underwater hull cleaning, propeller polishing, thruster work, in-water class survey and UWILD enquiries. Eight bases across the Gulf, South Asia and West Africa.",
  path: "/contact",
  keywords: [
    "contact CleanHull",
    "hull cleaning quote UAE",
    "propeller polishing enquiry",
  ...
  return (
    <>
      <JsonLd
        schema={[
          breadcrumbSchema(trail),
          {
            ...
            name: "Contact CleanHull Marine Services",
            description:
              "Enquiry and contact details for CleanHull Marine Services FZE.",
      ...
      <PageHero
        ...
        description="Our team is ready to assist with any underwater scope. The dive desk is manned around the clock — vessels do not arrive at convenient hours."
        trail={trail}
      />
