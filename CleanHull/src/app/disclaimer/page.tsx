...
export const metadata: Metadata = buildMetadata({
  title: "Disclaimer — CleanHull Marine",
  description:
    "CleanHull Marine disclaimer. Important legal disclaimers regarding the use of our website and services.",
  path: "/disclaimer",
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow="Legal"
        title="Disclaimer"
        description="Important information about the use of CleanHull Marine website and services"
        trail={trail}
      />
        ...
        <div className="container-page py-14 lg:py-20">
          <div className="prose prose-sm lg:prose-base max-w-3xl">
            ...
            <p>
              ...
              we strive to keep the information up to date and accurate, CleanHull Marine makes no
            ...
            <p>
              ...
              you place on such information is strictly at your own risk. In no event will CleanHull
            ...
            <p>
              ...
              control of CleanHull Marine. We have no control over the nature, content and availability
            ...
            <p>
              CleanHull Marine is not responsible for the content of external internet sites. You use
              these external sites at your own risk and subject to the terms and conditions of those
              sites. CleanHull Marine will not be liable for any damage or loss caused by inaccurate,
              misleading, or incomplete information or services provided through external sites.
            </p>

            <h2>Limitation of Liability</h2>
            <p>
              In no event shall CleanHull Marine be liable for any indirect, incidental, special,
              consequential, or punitive damages, including but not limited to, damages for loss of
              profits, goodwill, use, data, or other intangible losses (even if CleanHull Marine has
            ...
            <p>
              CleanHull Marine reserves the right to modify this disclaimer at any time. Changes to
